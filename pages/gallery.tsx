      ...
      <div style={{ display: "flex", gap: 0 }}>
        ...
        <div style={{ flex: 1, position: "relative" }}>
          <div style={{ background: item.after, height: 220, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span style={{ background: "rgba(255,255,255,0.85)", color: "#1a1a1a", padding: "4px 12px", borderRadius: 6, fontSize: 13, fontWeight: 600 }}>AFTER</span>
          </div>
        </div>
      </div>
      <div style={{ padding: "16px 20px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
          <span style={{ background: badge === "AI" ? "#8B7355" : "#2563eb", color: "#fff", fontSize: 11, fontWeight: 700, padding: "2px 8px", borderRadius: 4 }}>{badge}</span>
          <span style={{ fontWeight: 700, fontSize: 16, color: "#1a1a1a" }}>{item.style}</span>
        </div>
      ...
      <div style={{ fontFamily: "Roboto, sans-serif", color: "#1a1a1a", background: "#faf8f5" }}>
        ...
        <main style={{ maxWidth: 1000, margin: "0 auto", padding: "60px 24px" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <span style={{ display: "inline-block", background: "#8B7355", color: "#fff", fontSize: 12, fontWeight: 700, letterSpacing: 2, padding: "6px 16px", borderRadius: 20, marginBottom: 16 }}>GALLERY</span>
          ...
          <section style={{ marginBottom: 64 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
              <div style={{ width: 4, height: 28, background: "#8B7355", borderRadius: 2 }}></div>
              <div>
          ...
          <div style={{ textAlign: "center", padding: "48px 24px", background: "#fff", borderRadius: 16, boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
            ...
            <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
              <a href="/staging-dashboard.html" style={{ display: "inline-block", background: "#8B7355", color: "#fff", padding: "14px 32px", borderRadius: 8, textDecoration: "none", fontWeight: 700, fontSize: 16 }}>Try AI Staging Free</a>
