    ...
    <>
      ...
      <div style={{ fontFamily: "Roboto, sans-serif", color: "#1a1a1a", background: "#faf8f5" }}>
        ...
        <main style={{ maxWidth: 800, margin: "0 auto", padding: "60px 24px" }}>
          ...
          <p style={{ fontSize: 18, lineHeight: 1.7, color: "#444", marginBottom: 20 }}>
            We do not have any open positions listed at this time. However, we are always interested in hearing from exceptional candidates. If you believe you would be a great fit, reach out to us via our <a href="/home.html#contact" style={{ color: "#8B7355" }}>contact form</a>.
          </p>
        </main>
